...
//Fibonacci search uses + and - operator which is less costly then / operator which is used in binary operation
#include<iostream>
using namespace std;
...
OUTPUT:
 ...
 enter next element : 38   

 enter next element : 45

 enter next element : 56

 enter next element : 89

 array is : 1   38      45      56      89
